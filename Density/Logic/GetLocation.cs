...
namespace Density
{
    public class GetLocation : App
    {
        ...
        public JArray locationsArray { get { return JPositions; } }
        ...
        { return await IPLookupAsync(); }
        private async Task<string> IPLookupAsync()
        {
    ...
    public double? latitude(string icao)
    {
        ...
        { LookupLocation(); TranslateCity(location.CityName); }
